...
session_start();
?>
<form action="editCarnetPer/<?php echo $carnet->cod_asegurado;?>" method="POST" id="FormEditCarnetPer" enctype="multipart/form-data">
  <input type="hidden" name="_token" value="<?php echo $token; ?>">
  <div class="modal-header bg-dark flex">
    <h4 class="modal-title">EDITAR CARNET DE SEGURO PARA BENEFICIARIO </h4>
  ...
  <div class="modal-body pb-0 mb-0">
    ...
    <div class="row">
      ...
      <div class="form-group col-md-4">
        <label for="">Beneficiario de</label>
        <select name="beneficiario" id="beneficiario" class="form-control">
          <?php
          foreach($empleados as $key=>$value){
            if($value->cod_asegurado==$carnet->cod_asegurado_prov){
          ?>
          <option value="<?php echo $value->cod_asegurado;?>" selected><?php echo $value->nombre_empleado." ".$value->ap_paterno." ".$value->ap_materno;?></option>
          <?php
            }else{
          ?>
          <option value="<?php echo $value->cod_asegurado;?>"><?php echo $value->nombre_empleado." ".$value->ap_paterno." ".$value->ap_materno;?></option>
          <?php
            }
      ...
      <div class="row form-group col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                ...
                <input type="file" class="custom-file-input" id="imgPersona" name="imgPersona" onchange="previsualizar()" id="imgPersona" name="imgPersona">
                <input type="hidden" id="imgPersonaActual" name="imgPersonaActual" value="<?php echo $carnet->fotografia;?>">
                <label class="custom-file-label" for="imgPersona">Elegir archivo</label>
              </div>
        ...
        <div class="col-sm-6">
          <div class="form-group" style="text-align:center">
            ...
            ?>
            <img src="assets/dist/img/persona/<?php echo $carnet->fotografia;?>" alt="" width="150" class="img-thumbnail previsualizar">
            <?php
            }
            ?>
