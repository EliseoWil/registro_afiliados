          ...
          <div class="form-group" style="text-align:center">
           <?php
                if($carnet->fotografia==""){
                  ?>
                  <img src="assets/dist/img/empleado/user_default.jpg" alt="" width="150" class="img-thumbnail previsualizar">
                  <?php
                }else{
                  ?>
                   <img src="assets/dist/img/empleado/<?php echo $carnet->fotografia;?>" alt="" width="150" class="img-thumbnail previsualizar">
                  <?php
                }
                ?>
  ...
  $(function() {
    $('#FormEditCarnetEmp').validate({
      ...
      errorPlacement: function(error, element) {
        ...
        element.closEmp('.form-group').append(error);
      },
