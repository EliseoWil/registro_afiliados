  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="inicio" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Sistema INFUSENSE</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block" id="usuarioLogin">Usuario Administrador</a>
          </div>
        </div>
...
with font-awesome or any other icon font library -->
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="VDispositivo" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href="VMantDisp" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href="VMantDispPre" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
