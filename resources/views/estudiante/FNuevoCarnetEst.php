...
session_start();
?>
<form action="regCarnetEst/<?php echo $estudiante->cod_asegurado;?>" method="POST" id="FormRegCarnetEst" enctype="multipart/form-data">
  <input type="hidden" name="_token" value="<?php echo $token; ?>">
  <div class="modal-header bg-dark flex">
    <h4 class="modal-title">REGISTRAR CARNET DE SEGURO PARA ESTUDIANTE </h4>
